...
enum class TemporalChoice { Now, Later, Resume, Review, Wait, Skip };
struct TemporalOption { Intention intention; std::int64_t earliest{0}; std::int64_t deadline{0}; std::int64_t last_active{0}; std::int64_t recurrence_seconds{0}; double urgency{0.0}; double delayed_value{0.5}; double interruption_cost{0.0}; bool interrupted{false}; bool stale_review{false}; };
